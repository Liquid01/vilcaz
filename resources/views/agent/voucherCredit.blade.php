                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="card">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <div class="input-field">
                                        <input name="pr" type="text" value="{{config('global.voucher_value')}}" disabled class="validate form-control{{ $errors->has('pr') ? ' is-invalid' : '' }}" placeholder="Voucher price">
                                        <input name="price" type="hidden" value="{{config('global.voucher_value')}}" class="validate form-control{{ $errors->has('price') ? ' is-invalid' : '' }}" placeholder="Voucher price">
                                        @if ($errors->has('price'))
                                            <span class="invalid-feedback">
