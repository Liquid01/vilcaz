    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
        ...
        {{--<div class="navbar-custom-menu hidden-xs">--}}
            ...
            <ul class="navbar navbar-right">
                <!--Notification-->
                <li class="dropdown">
                    <a class="dropdown-toggle btn btn-sm btn-danger" onclick=" document.getElementById('logout-form').submit();">
        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    <li class="active-link"><a href="{{route('agentHome')}}"><i class="material-icons">dashboard</i>Dashboard</a></li>
                    <li>
                        <a><i class="material-icons">email</i>Tools<span class="fa arrow"></span></a>
                    ...
                    <li>
                        <a><i class="material-icons">money</i>Profile<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
