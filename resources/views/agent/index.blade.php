                        ...
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            <div class="panel cardbox bg-success">
                                <div class="panel-body card-item panel-refresh">
                                    ...
                                    <div class="timer" data-to="{{\App\VoucherSales::where('created_by', auth()->user()->username)->sum('voucher_quantity')}}" data-speed="1500">0</div>
                                    <div class="cardbox-icon">
                                        <i class="material-icons">loyalty</i>
                                    </div>
                                    <div class="card-details">
                                        <h4>Sold Vouchers</h4>
                                        <a href="{{route('agentCreditVoucher')}}" class="btn royal darken-2 ">
                                            Credit Voucher
                                        </a>
                                    </div>
                                </div>
                        ...
                        {{--<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">--}}
                            {{--<div class="panel cardbox bg-warning">--}}
                                {{--<div class="panel-body card-item panel-refresh">--}}
                                    ...
                                    {{--<div class="card-details">--}}
                                        {{--<h4>Voucher Value</h4>--}}
                                        {{--<button class="btn cyan">Check Estimate</button>--}}
                                    {{--</div>--}}
                                {{--</div>--}}
                            {{--</div>--}}
                        {{--</div>--}}
